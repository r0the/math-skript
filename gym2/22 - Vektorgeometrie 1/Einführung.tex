...
\begin{center}
  \begin{tikzpicture}
    ...
    \tkzDrawSegment[thick,vector style](D,C)
    \tkzLabelSegment[above right](D,C){$\vv{b}$}

    \tkzDrawSegment[red,thick,vector style](A,C)
...
\begin{center}
  \begin{tikzpicture}
    ...
    \tkzDrawSegment[thick,vector style](A,B)
    \tkzLabelSegment[below left](A,B){$\vv{b}$}

    \tkzDrawSegment[thick,vector style](B,C)
...
\begin{center}
  \begin{tikzpicture}
    ...
    \tkzDrawSegment[thick,vector style](A2,A3)
    \tkzLabelSegment[above left](A2,A3){$\vv{a}$}

    \tkzDrawSegment[thick,red,vector style](B1,B2)
...
\begin{center}
  \begin{tikzpicture}
    ...
    \tkzDrawSegment[thick,vector style](B,Z1)
    \tkzLabelSegment[above right](B,Z1){$-\vv{b}$}

    \tkzDrawSegment[thick,vector style](B,Z)
    \tkzLabelSegment[above right](B,Z){$\vv{b}$}

    \tkzDrawSegment[red,thick,vector style](A,Z1)
...
\begin{center}
  \begin{tikzpicture}
    ...
    \tkzDrawSegment[thick,vector style](Z1,B)
